...
export default function PaySmallSmall() {
  return (
    <section className="py-12 sm:py-16 md:py-24 bg-secondary text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 leading-tight">
              No Money? <span className="text-primary">Start Small.</span>
            </h2>
            ...
            <Button to="/pay-small-small" variant="primary" size="md" className="w-full sm:w-auto">
              Check Payment Plan <ArrowRight size={18} />
            </Button>
          </div>

          {/* Payment Calculator Preview */}
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 sm:p-6 md:p-8 border border-white/20">

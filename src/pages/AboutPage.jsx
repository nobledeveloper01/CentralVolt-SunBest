      ...
      <section className="py-8 sm:py-12 md:py-20 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-3 sm:mb-4">Our Mission</h2>
              ...
              <h3 className="text-sm sm:text-base font-bold text-text-primary mb-2 sm:mb-3">We design solar systems that:</h3>
              <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8">
                {values.map((v) => (
                  <li key={v} className="flex items-center gap-2 sm:gap-3 text-sm sm:text-base text-text-secondary">
              ...
              <div className="flex items-center gap-2 text-text-secondary text-sm mb-4 sm:mb-6">

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-6 md:p-8">
              <h2 className="text-xl sm:text-2xl font-bold text-charcoal mb-4 sm:mb-6">Payment Calculator</h2>
              ...
              <div className="space-y-4 sm:space-y-5">
                ...
                <div className="bg-primary-lighter rounded-xl sm:rounded-2xl p-4 sm:p-6 space-y-3 sm:space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg sm:text-xl font-bold text-charcoal">{formatPrice(product.price)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-xs sm:text-sm text-gray-600">Deposit (30%)</span>
                  ...
                  <div className="border-t border-primary/20 pt-3 sm:pt-4 flex justify-between items-center">
                    ...
                    <div className="text-right">
                      <span className="text-xl sm:text-2xl font-bold text-charcoal">{formatPrice(monthly)}</span>
            ...
            {/* How it works */}
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-charcoal mb-5 sm:mb-8">How It Works</h2>
              <div className="space-y-4 sm:space-y-6">
                {steps.map((s) => (
                  <div key={s.step} className="flex gap-3 sm:gap-4">
                    ...
                    <div>
                      <h3 className="text-sm sm:text-base font-bold text-charcoal">{s.title}</h3>
              ...
              {/* Important Notes */}
              <div className="mt-8 sm:mt-10 bg-green-50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                <h3 className="text-sm sm:text-base font-bold text-charcoal mb-2 sm:mb-3 flex items-center gap-2">
                  <AlertCircle size={16} className="sm:w-[18px] sm:h-[18px] text-green-600" />
                  Important Notes
                </h3>
                <ul className="space-y-1.5 sm:space-y-2">
                  {notes.map((note) => (
                    <li key={note} className="flex items-center gap-2 text-gray-600 text-xs sm:text-sm">
